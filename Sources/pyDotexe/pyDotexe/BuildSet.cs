...
namespace pyDotexe
{
    public class BuildSet
    {
        ...
        public void Decision()
        {
            ...
            {
                Console.WriteLine("[!] Module-hooks data is not found. Installation is starting...\r\n");
            ...
            try
            {
                ...
                Console.WriteLine("\r\n[+] Python version detected: " + py_version_raw + ".x");
            ...
            {
                Console.WriteLine("[-] Python library file is not found: [python"+ py_version +".dll]");
            }
            catch
            {
                Console.WriteLine("[-] Python binary is not found: [" + python_binary_path + "]");
            }
        }
