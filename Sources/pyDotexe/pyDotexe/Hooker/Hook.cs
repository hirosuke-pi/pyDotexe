...
namespace pyDotexe.Hooker
{
    public class Hook
    {
        ...
        public static void Update(string dirpath, string now_dirpath)
        {
                    ...
                    foreach (string filename in Directory.GetFiles(dirpath, "*", SearchOption.AllDirectories))
                    {
                        ...
                        catch
                        {
                            try
                            {
                                ...
                                Console.WriteLine(" + Updated: " + distfile);
                            }
                            catch { }
                        }
                    }
            ...
            {
                Console.WriteLine("[!] ["+ dirpath +"] is not found.");
            }
        }
        ...
        {          
            try
            {
                ...
                string url = "https://github.com/betacode-project/pyDotexe/raw/master/pyDotexe_Binary/Latest/module-hooks.zip";
